            ...
            <div className="data-block">
              <h1>
                <a
                  ...
                  rel="noreferrer"
                >
                  <u>{`${solarSystemInfo[0].name.toUpperCase()}`}</u>
                </a>
              </h1>
              <p>
            ...
            <div className="data-block">
              <h1>
                <a
                  ...
                  rel="noreferrer"
                >
                  <u>{`${solarSystemInfo[1].name.toUpperCase()}`}</u>
                </a>
              </h1>
              <p>
            ...
            <div className="data-block">
              <h1>
                <a
                  ...
                  rel="noreferrer"
                >
                  <u>{`${solarSystemInfo[2].name.toUpperCase()}`}</u>
                </a>
              </h1>
              <p>
            ...
            <div className="data-block">
              <h1>
                <a
                  ...
                  rel="noreferrer"
                >
                  <u>{`${solarSystemInfo[3].name.toUpperCase()}`}</u>
                </a>
              </h1>
              <p>
            ...
            <div className="data-block">
              <h1>
                <a
                  ...
                  rel="noreferrer"
                >
                  <u>{`${solarSystemInfo[4].name.toUpperCase()}`}</u>
                </a>
              </h1>
              <p>
            ...
            <div className="data-block">
              <h1>
                <a
                  ...
                  rel="noreferrer"
                >
                  <u>{`${solarSystemInfo[5].name.toUpperCase()}`}</u>
                </a>
              </h1>
              <p>
            ...
            <div className="data-block">
              <h1>
                <a
                  ...
                  rel="noreferrer"
                >
                  <u>{`${solarSystemInfo[6].name.toUpperCase()}`}</u>
                </a>
              </h1>
              <p>
            ...
            <div className="data-block">
              <h1>
                <a
                  ...
                  rel="noreferrer"
                >
                  <u>{`${solarSystemInfo[7].name.toUpperCase()}`}</u>
                </a>
              </h1>
              <p>
            ...
            <div className="data-block">
              <h1>
                <a
                  ...
                  rel="noreferrer"
                >
                  <u>{`${solarSystemInfo[8].name.toUpperCase()}`}</u>
                </a>
              </h1>
              <p>
